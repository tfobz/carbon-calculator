import { MobilityType } from "./mobility_emission-module";
...
export class MobilityTypeFactory{
    static create(id: string): MobilityType{
        switch(id){
...
class PkwMobilityType implements MobilityType{
    id: string = PKW_MOBILITY_TYPE_ID;
    factor: number = 0.22;
}


class BusMobilityType implements MobilityType{
    id: string = BUS_MOBILITY_TYPE_ID;
    factor: number = 0.055;
}


class TrainMobilityType implements MobilityType{
    id: string = TRAIN_MOBILITY_TYPE_ID;
    factor: number = 0.008;
}


class CityBusMobilityType implements MobilityType{
